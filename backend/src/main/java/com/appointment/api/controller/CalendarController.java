...
public class CalendarController {
     ...
     * 
     * GET
     * /api/calendar?start_time=2025-12-18T04:00:00&end_time=2025-12-18T20:00:00&interval=15&company_id=2&employee_id=11
     * 
    ...
    public ResponseEntity<?> getCalendarData(
        ...
        try {
            if (employeeId != null && employeeId.trim().isEmpty() || "undefined".equals(employeeId)) {
                employeeId = null;
            }
            ...
            log.info(
                    "Getting calendar data for company_id: {}, employee_id: {}, start_time: {}, end_time: {}, interval: {}",
                    companyId, employeeId, startTime, endTime, interval);
